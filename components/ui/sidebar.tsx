...
export function SidebarTrigger({ className }: { className?: string }) {
  ...
  return (
    <Button variant="ghost" size="icon" onClick={toggle} className={cn("h-9 w-9 p-0", className)}>
...
export function Sidebar({ children }: { children: React.ReactNode }) {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={close}>
      <SheetContent side="left" className="p-0 w-[280px] bg-gray-900 border-r border-gray-800">
        {children}
      </SheetContent>
    </Sheet>
  )
...
export function SidebarHeader({ children, className }: { children: React.ReactNode; className?: string }) {
  return <div className={cn("p-4 border-b border-gray-800", className)}>{children}</div>
}
...
export function SidebarFooter({ children, className }: { children: React.ReactNode; className?: string }) {
  return <div className={cn("p-4 mt-auto border-t border-gray-800", className)}>{children}</div>
}
...
const SIDEBAR_CONTEXT_NAME = "sidebar:state"
const SIDEBAR_CONTEXT_MAX_AGE = 60 * 60 * 24 * 7
const SIDEBAR_CONTEXT_WIDTH = "16rem"
const SIDEBAR_CONTEXT_WIDTH_MOBILE = "18rem"
const SIDEBAR_CONTEXT_WIDTH_ICON = "3rem"
const SIDEBAR_CONTEXT_KEYBOARD_SHORTCUT = "b"
...
const SidebarRailOld = React.forwardRef<HTMLButtonElement, React.ComponentProps<"button">>(
  ({ className, ...props }, ref) => {
    const { toggleSidebar } = useSidebarOld()
...
SidebarRailOld.displayName = "SidebarRail"
...
SidebarInsetOld.displayName = "SidebarInset"
